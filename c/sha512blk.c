...
#define rol32(word,bits) (((word) << (bits)) | ((word) >> (32-(bits))))
 ...
 */
inline uint32_t get_unaligned_be32(uint32_t *x) {
    uint32_t _v;
    ((uint8_t *)&_v)[0] = (*x >> 24) & 0xf;
    ((uint8_t *)&_v)[1] = (*x >> 16) & 0xf;
    ((uint8_t *)&_v)[2] = (*x >> 8)  & 0xf;
    ((uint8_t *)&_v)[3] = (*x)  & 0xf;
    return _v; 
}
